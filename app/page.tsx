...
export default function Home() {
  ...
  return (
    <>
      <Layout>
        <>
          <div className=" container w-full h-full grid grid-cols-1 lg:grid-cols-2 gap-x-[40px] justify-center items-center xl:items-start ">
          ...
          <div className=" container w-full h-full grid grid-cols-1 lg:grid-cols-2 gap-x-[40px] justify-center items-center  ">
