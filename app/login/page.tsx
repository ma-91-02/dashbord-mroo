...
export default function LogIn() {
  return (
    <main className='flex flex-col xl:flex-row bg-gradient-to-tr from-[#222] via-[#990607]/50 px-5 xl:px-[50px] to-[#444]  justify-center items-center h-screen'>
      <div className='flex flex-col h-[50%] xl:h-full items-center justify-center w-full'>
      ...
      <div className="h-[50%]  py-10 flex justify-center items-center w-full">
